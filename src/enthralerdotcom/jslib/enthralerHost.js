...
EnthralerHost.addMessageListeners = function() {
	window.addEventListener("message",function(e) {
		...
		switch(_g1) {
		case "enthraler.broadcast.schemaUrl":
			if(currentFrame != null) {
		...
		case "iframe.resize":
			...
			break;
		default:
			haxe_Log.trace("Received message from frame",{ fileName : "EnthralerHost.hx", lineNumber : 64, className : "EnthralerHost", methodName : "addMessageListeners", customParams : [frameWindow,data]});
		}
	});
};
Math.__name__ = true;
